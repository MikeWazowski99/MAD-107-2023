...
/* What I have learned is that if statements are extremely useful when trying to get specific things to happen in a function and the modulus is used for finding a remainder 
 */
